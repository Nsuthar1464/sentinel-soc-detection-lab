...
Created the Log Analytics workspace and enabled Microsoft Sentinel on it
Connected the Microsoft Entra ID data connector
Verified logs were flowing by querying the SigninLogs table
